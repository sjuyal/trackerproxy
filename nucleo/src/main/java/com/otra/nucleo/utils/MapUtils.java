...
import com.otra.dataaccess.entities.Coordinate;
...
public class MapUtils {
    ...
    */
    ...
    public static boolean coordinateInArea(List<Coordinate> polygon, Coordinate coord) {
        int i, j;
        boolean isInside = false;
        //create an array of coordinates from the region boundary list
        Coordinate[] verts = polygon.toArray(new Coordinate[polygon.size()]);
